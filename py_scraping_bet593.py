...
https://sb2frontend-altenar2.biahosted.com/api/Sportsbook/GetFavouritesChamps?timezoneOffset=300&langId=4&skinName=alboran&configId=1&culture=es-ES&countryCode=PA&deviceType=Mobile&numformat=en&integration=bet593&period=periodmonth&sportId={cod_sport}&startDate={cad_fec_hora_ini}&endDate={cad_fec_hora_ini}
...
endpoint_campeonatos = ('''
https://sb2frontend-altenar2.biahosted.com/api/SportsBook/GetMenuBySport?timezoneOffset=300&langId=4&skinName=bet593&configId=1&culture=es-ES&countryCode=PA&deviceType=Desktop&numformat=en&integration=bet593&sportId={cod_sport}&period=periodall&startDate={cad_fec_hora_ini}&endDate={cad_fec_hora_fin}
''').format(cod_sport=str(66),cad_fec_hora_ini=cad_start_utc,cad_fec_hora_fin=cad_end_utc)
...
for iter_campeonato in array_dict_campeonatos:    
    endpoint_eventos = ('''https://sb2frontend-altenar2.biahosted.com/api/Sportsbook/GetEvents?timezoneOffset=300&langId=4&skinName=bet593&configId=1&culture=es-ES&countryCode=PA&deviceType=Mobile&numformat=en&integration=bet593&sportids=0&categoryids=0&champids={cod_campeonato}&group=AllEvents&period=periodall&withLive=false&outrightsDisplay=none&marketTypeIds=&couponType=0&startDate={cad_fec_hora_ini}&endDate={cad_fec_hora_fin}
                ...
                if odds_iter_item['Name'] == '1x2':
                    ...
                    if fechaEvento == None:
                        ...
                        if ((odd_1>0) and (odd_x>0) and (odd_2>0)):
                            ...
                            id_unico = "EC-" + str(cadFechaEvento) + "-FUTBOL-" + slugify(torneo) + "-" + slugify(evento) +str(en_vivo.upper())+"-Bet593"
